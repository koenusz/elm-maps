...
setTileServer tileServer =
    opaqueMap <| Map.setTileServer tileServer
...
setHeight height =
    opaqueMap <| Map.setHeight height
...
setTileSize tileSize =
    opaqueMap <| Map.setTileSize tileSize
...
setZoom zoomLevel =
    opaqueMap <| Map.setZoom zoomLevel
...
zoomTo thiszoom offset =
    opaqueMap <| Map.zoomTo thiszoom offset
...
viewBounds bounds =
    opaqueMap <| Map.viewBounds bounds
